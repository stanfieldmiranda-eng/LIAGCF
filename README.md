...
To access: copy and paste `https://doi.org/10.5281/zenodo.19553772` into your browser's address bar.
...
[Website](https://www.drmirandastanfield.com) · [LinkedIn](https://linkedin.com/in/mirandastanfield) · RAIS Publication DOI: `10.5281/zenodo.19553772`
...
> Stanfield, M. (2026). Evaluating control-based AI governance in cybersecurity GRC programs: An expert assessment study. *RAIS Conference Proceedings, March 12–13, 2026.* DOI: `10.5281/zenodo.19553772` (copy and paste into browser address bar to access)
